...
| Item | Status |
|------|--------|
| N≤12 correctness + speed | ✅ |
| N=14–18 Kronecker correctness | ✅ (~1e-17 vs FWT) |
...
|------------|----------------|---------------|-----|
| ≤12 | — | `iqp_phase_fwt_normalize_tc_kernel` | ✅ |
...
### Micro encode-only (`benchmark_pr6.py --path both`, batch=32)
...
| `test_iqp_tc_path.py` | N=14–18 tests |